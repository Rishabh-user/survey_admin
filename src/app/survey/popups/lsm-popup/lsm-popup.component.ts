...
@Component({
  selector: 'app-lsm-popup',
  templateUrl: './lsm-popup.component.html',
  styleUrls: ['./lsm-popup.component.css']
})
export class LsmPopupComponent {
    @ViewChild('LsmModal', { static: true }) modal!: ModalDirective;
