...
@Component({
  selector: 'app-monthly-income-foreign-popup',
  templateUrl: './monthly-income-foreign-popup.component.html',
  styleUrls: ['./monthly-income-foreign-popup.component.css']
})
export class MonthlyIncomeForeignPopupComponent {

  @ViewChild('MonthlyIncomeModalforeign', { static: true }) modal!: ModalDirective;
